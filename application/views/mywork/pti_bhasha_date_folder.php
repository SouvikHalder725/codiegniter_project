              ...
              <div class="card card-table">
                <div class="card-header col-md-12 d-flex">
                   ...
                   <!--  <div class="dropdown col-md-2 mx-3">
                     ...
                     <a href="<?php echo base_url(); ?>Mywork_controller/all_folder" class="btn btn-warning col-md-2 mx-2"><i class="fa fa-arrow-left"></i></a>
                  </div>
                ...
                <div class="card-body table-responsive">
                  ...
                  <table class="table table-striped table-hover text-left">
                    ...
                    <tbody>
                      ...
                      $list=scandir('document_uploads/PTI_BHASHA');
                        ...
                        $length=strlen($value);
                         ...
                         if($length>5 && $value!="picked"){
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url('Mywork_controller/pti_bhasha_news_date_folder/'.$value.''); ?>"><h3><i class="fa fa-folder"></i> <?php echo $value; ?></h3></a>
                            </td>
                            <td>
                             
                                  <!-- <a class="btn btn-primary mx-2" href="#"><i class="fa fa-edit"></i></a>
                                  <a class="btn btn-info mx-2" href="#"><i class="fa fa-file"></i></a> -->
                                  <a class="btn btn-danger" href="#" onclick="confirm_del_pti_bhasha()"><i class="fa fa-trash"></i></a>
                                  <input type="hidden" name="value" id="confirm_del_pti_bhasha" value="<?php echo $value; ?>">
