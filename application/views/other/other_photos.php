            ...
            <div class="col-12 col-lg-12">
              <div class="card card-table">
                <div class="card-header col-md-12 d-flex">
                    ...
                    <div class="title col-md-4">OTHER PHOTOS</div>
                    


                    <div class="tools dropdown col-md-8 d-flex">
                       <form class="col-md-10" action="<?php echo base_url(); ?>Search_controller/other_photos_search" method="post">
                      ...
                      <a href="<?php echo base_url(); ?>Bengali_controller/other_photos" class="btn btn-info col-md-1 mx-1"> <i class="fa-solid fa-rotate"></i></a>
                ...
                <div class="card-body table-responsive">
                      ...
                      foreach ($file_name as $value) {
                       ...
                       // this is for getting image information hide inside the image coming from pti or uni   
                        ...
                        // $info = exif_read_data("C:\Wire_Agency\UNI_Photos/".$value."",0,true);                                                
                          $size = getimagesize("document_uploads/".$value->date."/OTHER_PHOTOS/".$value->file_name."", $info);
                          ...
                          if(is_array($info)) 
                          {
                            if(isset($info['APP13'])){
                              ...
                              $data_title_saved=$this-> db ->update('bengali_photos');
                        ...
                        <td>
                          ...
                          <img id="news_img"  src="<?php echo base_url(); ?>document_uploads/<?php echo $date; ?>/OTHER_PHOTOS/<?php echo $value->file_name; ?>" width="80" height="80" alt="Pti Photo">
                        ...
                        <td>
                           <?php  
                                  ...
                                  $list=scandir('document_uploads/picked/'.$date.'/OTHER_PHOTOS');
                                      ...
                                      foreach ($list as $new_value) { 
                                        ...
                                        if($length>5){
                                        $file_list=scandir('document_uploads/picked/'.$date.'/OTHER_PHOTOS/'.$new_value.'/');
                                    ...
                                    <div id="pick_form">
                                      <form method="post" action="<?php echo base_url(); ?>Bengali_controller/pick_other_photos">
                        ...
                        <td>
                          <div class="d-flex mx-2 text-center"> 
                               ...
                               <?php 
                                  ...
                                  $data_res= $this-> db ->get('bengali_photos_pick_realise');
                 ...
                 <div class="col-md-12 my-1">
                  ...
                  <nav aria-label="Page navigation example text-center my-3">
                    <ul class="pagination">
                      <li class="page-item">
                        <a class="page-link" href="<?php echo base_url(); ?>Bengali_controller/other_photos" aria-label="Previous">
                    ...
                    if($i>0 && $i<=$pagination){?>
                        ...
                        <li class="page-item">
                          ...
                          <form method="post" action="<?php echo base_url(); ?>Bengali_controller/other_photos">
                            <input type="hidden" name="page_no" value="<?php echo $i; ?>">
                            <button class="page-link <?php print ($i==$page_number) ? "active" : ""; ?>" name="bengali_photo_page" type="submit">
                    ...
                    <?php }
                      ...
                      <li class="page-item">
                          ...
                          <form method="post" action="<?php echo base_url(); ?>Bengali_controller/other_photos">
                            ...
                            <button class="page-link" name="bengali_photo_page" type="submit">
