            ...
            <div class="col-12 col-lg-12">
              ...
              <div class="card card-table">
               <div class="card-header col-md-12 d-flex">
                   <div class="title col-md-4">UNI VARTA</div>
                    

                 <div class="tools dropdown col-md-8 d-flex">
                    <form class="col-md-10" action="<?php echo base_url(); ?>Search_controller/uni_varta_search" method="post">
                      ...
                      <a href="<?php echo base_url(); ?>File_controller/uni_varta" class="btn btn-info col-md-1 mx-1"> <i class="fa-solid fa-rotate"></i></a>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="user-avatar d-flex">
                              <img src="<?php echo base_url(); ?>asset/img/hindi_file_icon.png" width="80" height="80" alt="Avatar">
                            </div>
                          </td>
                          ...
                          <td>
                            ...
                            $list=scandir('document_uploads/picked/'.$date.'/UNI_Varta');
                                ...
                                foreach ($list as $new_value) { 
                                  ...
                                  if($length>5){
                                  $file_list=scandir('document_uploads/picked/'.$date.'/UNI_Varta/'.$new_value.'/');
                                    ...
                                    <div id="pick_form">
                                      <form method="post" action="<?php echo base_url(); ?>File_controller/pick_varta_story">
                          ...
                          <td>
                              <div class="d-flex mx-2 text-center"> 
                                   ...
                                   <?php 
                                      ...
                                      $data_res= $this-> db ->get('uni_varta_pick_realise');
                         ...
                         <!-- Modal -->
                                  <div class="modal fade" id="view_uni_varta_story_modal_<?php echo $value->id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-xl">
                                      <div class="modal-content">
                                        <div class="modal-header">
              ...
              <?php  $r++;
                  ...
                  <div class="col-md-12 my-1">
                    ...
                    <nav aria-label="Page navigation example text-center my-3">
                      <ul class="pagination">
                        <li class="page-item">
                          <a class="page-link" href="<?php echo base_url(); ?>File_controller/uni_varta" aria-label="Previous">
                        ...
                        <?php for ($i=$page_number-2; $i <=$page_number+2 ; $i++) { 
                         if($i>0 && $i<=$pagination){?>
                          <li class="page-item">
                            ...
                            <form method="post" action="<?php echo base_url(); ?>File_controller/uni_varta">
                              <input type="hidden" name="page_no" value="<?php echo $i; ?>">
                              <button class="page-link <?php print ($i==$page_number) ? "active" : ""; ?>" name="uni_varta_page" type="submit">
                      ...
                      <?php } 
                        ...
                        <li class="page-item">
                            ...
                            <form method="post" action="<?php echo base_url(); ?>File_controller/uni_varta">
                              ...
                              <button class="page-link " name="uni_varta_page" type="submit">
