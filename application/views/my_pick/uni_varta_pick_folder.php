                ...
                <div class="card-body table-responsive">
                  ...
                  <table class="table table-striped table-hover text-left">
                    ...
                    <tbody>
                      ...
                      $list=scandir('document_uploads/UNI_Varta/picked');
                      ...
                      foreach ($list as $value) { 
                        $length=strlen($value);
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url('Mywork_controller/uni_varta_pick_news/'.$value.''); ?>"><h3><i class="fa fa-folder"></i> <?php echo $value; ?></h3></a>
                            </td>
                            <td>
