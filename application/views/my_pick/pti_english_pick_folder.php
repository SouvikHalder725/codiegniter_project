                ...
                <div class="card-body table-responsive">
                  ...
                  <table class="table table-striped table-hover text-left">
                    ...
                    <tbody>
                      ...
                      $list=scandir('document_uploads/PTI_ENG/picked');
                        ...
                        $length=strlen($value);
                         ...
                         if($length>5){
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url('Mywork_controller/pti_english_pick_news/'.$value.''); ?>"><h3><i class="fa fa-folder"></i> <?php echo $value; ?></h3></a>
                            </td>
                            <td>
