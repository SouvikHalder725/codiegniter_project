                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <img src="<?php echo base_url(); ?>document_uploads/<?php echo $value->date; ?>/OTHER_PHOTOS/<?php echo $value->file_name; ?>" width="80" height="80" alt="Pti Photo">
                        ...
                        <td width="40%">
                          <div class="px-2">
                            ...
                            <p class="ellipsis" oncopy="return false"><b><?php echo $subject; ?></b></p>                            
                          </div>
                        ...
                        <td>
                           <?php  
                                    ...
                                    <div id="pick_form">
                                     <form method="post" action="<?php echo base_url(); ?>Archivepick_controller/archive_pick_other_photos_story">
                                      ...
                                      <div class="modal-content" style="width:100%;">
                                        ...
                                        <div class="modal-body">
                                          <div class="row col-md-12 mx-3 my-3 text-left">
                                            ...
                                            <img width="" height="" src="<?php echo base_url(); ?>document_uploads/PTI_Photos/<?php echo $value->date; ?>/<?php echo $value->file_name; ?>">
