            ...
            <div class="col-12 col-lg-12">
              ...
              <div class="card card-table">
                <div class="card-header col-md-12 d-flex">
                   ...
                   <div class="title col-md-4">PTI BHASHA</div>
                   
                   <div class="tools dropdown col-md-8 d-flex">
                    <form class="col-md-10" action="<?php echo base_url(); ?>Search_controller/pti_search" method="post">
 ...
 -->
                                              ...
                                              $list=scandir('document_uploads/picked/'.$date.'/PTI_BHASHA');
                                                  ...
                                                  foreach ($list as $new_value) { 
                                                    ...
                                                    if($length>5){
                                                    $file_list=scandir('document_uploads/picked/'.$date.'/PTI_BHASHA/'.$new_value.'/');
                                              ...
                                              <td>
                                                <div class="d-flex mx-2 text-center"> 
                                                     ...
                                                     <?php 
                                                        ...
                                                        $data_res= $this-> db ->get('pti_bhasha_pick_realise');
               ...
               <div class="col-md-12 my-1">
                ...
                <nav aria-label="Page navigation example text-center my-3">
                  <ul class="pagination">
                    <li class="page-item">
                      <a class="page-link" href="<?php echo base_url(); ?>File_controller/pti_bhasha" aria-label="Previous">
                  ...
                  <?php for ($i=$page_number-2; $i <=$page_number+2 ; $i++) { 
                    if($i>0 && $i<=$pagination){?>
                      ...
                      <li class="page-item">
                        ...
                        <form method="post" action="<?php echo base_url(); ?>File_controller/pti_bhasha">
