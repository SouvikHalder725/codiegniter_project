            ...
            <div class="col-12 col-lg-12">
              ...
              <div class="card card-table">
                <div class="card-header col-md-12 d-flex">
                   ...
                   <div class="title col-md-4">LOCAL STORY</div>
                   
                   <div class="tools dropdown col-md-8 d-flex">
                    <form class="col-md-8" action="<?php echo base_url(); ?>Search_controller/local_news_search" method="post">
                     ...
                     <a class="btn btn-primary mx-1 text-center col-md-2" href="<?php echo base_url(); ?>Local_controller/local_news_form"><i class="fa fa-plus mx-1"></i><b>Create Story</b></a>
                    
                     <a href="<?php echo base_url(); ?>Local_controller/own_local_story" class="btn btn-info mx-1 col-md-1"> <i class="fa-solid fa-rotate mx-1"></i><b></b></a>
                    ...
                    <tbody>
                      ...
                      ?>
                                            ...
                                            <tr>
                                              ...
                                              $list=scandir('document_uploads/picked/'.$date.'/LOCAL_STORY');
                                                  ...
                                                  foreach ($list as $new_value) { 
                                                    ...
                                                    if($length>5){
                                                    $file_list=scandir('document_uploads/picked/'.$date.'/LOCAL_STORY/'.$new_value.'/');
                                                      ...
                                                      <div id="pick_form" class="mx-2">
                                                            <form method="post" action="<?php echo base_url(); ?>Local_controller/pick_local_story">
                                                ...
                                                <div class="d-flex mx-2 text-center"> 
                                                     ...
                                                     <?php 
                                                       $pick_real_id=$value->id;
                                                        ...
                                                        $data_res= $this-> db ->get('local_story_pick_realise');
                                                        ...
                                                        <a href="<?php echo base_url('Local_controller/local_news_edit/'.$value->id.''); ?>" class="btn btn-success mx-1 text-center"><i class="fa fa-edit mx-1"></i>Edit</a>                             
               ...
               <div class="col-md-12 my-1">
                ...
                <nav aria-label="Page navigation example text-center my-3">
                  <ul class="pagination">
                    <li class="page-item">
                      <a class="page-link" href="<?php echo base_url(); ?>Local_controller/own_local_story" aria-label="Previous">
                  ...
                  <?php for ($i=$page_number-2; $i <=$page_number+2 ; $i++) { 
                    if($i>0 && $i<=$pagination){?>
                      ...
                      <li class="page-item">
                        ...
                        <form method="post" action="<?php echo base_url(); ?>Local_controller/own_local_story">
                          <input type="hidden" name="page_no" value="<?php echo $i; ?>">
                          <button class="page-link <?php print ($i==$page_number) ? "active" : ""; ?>" name="pti_bhasha_page" type="submit">
