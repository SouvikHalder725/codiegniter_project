 <div class="row my-4">
    ...
    <div class="col-12 col-lg-12">
       <form method="post" action="<?php echo base_url(); ?>welcome/pick_varta_story">
        <div class="card card-table">
           <div class="card-header col-md-12 d-flex">
            ...
            <div class="card-body table-responsive">
	           ...
	           <!-- <form action="<?php //echo base_url('welcome/uni_varta_file_update'); ?>" method="post"> -->
	           	     <input type="hidden" name="pick_file_name" value="<?php echo $file_name; ?>">
				
					       <textarea rows="40"  class="form-control" name="text" style="overflow:auto;"><?PHP  echo htmlspecialchars($text2);  ?></textarea>  
