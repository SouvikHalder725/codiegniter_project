            ...
            <div class="col-12 col-lg-12">
              ...
              <div class="card card-table">
                <div class="card-header col-md-12 d-flex">
                 ...
                 <div class="title col-md-4">PTI ENGLISH</div>
                  
                <div class="tools dropdown col-md-8 d-flex">
                    <form class="col-md-10" action="<?php echo base_url(); ?>Search_controller/pti_english_search" method="post">
                      ...
                      <a href="<?php echo base_url(); ?>File_controller/pti_english" class="btn btn-info col-md-1 mx-1"> <i class="fa-solid fa-rotate"></i></a>
                ...
                <div class="card-body table-responsive">
                    ...
                    <tbody>
                     ...
                     <?php
                      ...
                      <tr>
                          ...
                          <!-- <td align="center"><input type="checkbox" name="checked_input_value[]" id="checked_input_value" class="checkbox" value="<?php //echo $value['scan_result']; ?>"></td>    -->
                          <td>
                              <div class="user-avatar d-flex">
                               
                                <img src="<?php echo base_url(); ?>asset/img/english_file_icon.webp" width="60" height="60" alt="Avatar">
                         ...
                         <td>
                          <?php  
                                              ...
                                              $list=scandir('document_uploads/picked/'.$date.'/PTI_ENG');
                                                  ...
                                                  foreach ($list as $new_value) { 
                                                    ...
                                                    if($length>5){
                                                    $file_list=scandir('document_uploads/picked/'.$date.'/PTI_ENG/'.$new_value.'/');
                                          ...
                                          <div id="pick_form">
                                            <form method="post" action="<?php echo base_url(); ?>File_controller/pick_english_story">
                        ...
                        <td>
                            <div class="d-flex mx-2 text-center"> 
                                 ...
                                 <?php 
                                    ...
                                    $data_res= $this-> db ->get('pti_english_pick_realise');
                           ...
                           <!-- Modal -->
                                  <div class="modal fade" id="view_pti_eng_story_modal_<?php echo $value->id;  ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-xl">
                                      <div class="modal-content">
                                        <div class="modal-header">
                 ...
                 <div class="col-md-12 my-1">
                  ...
                  <nav aria-label="Page navigation example text-center my-3">
                    <ul class="pagination">
                      <li class="page-item">
                        <a class="page-link" href="<?php echo base_url(); ?>File_controller/pti_english" aria-label="Previous">
                    ...
                    if($i>0 && $i<=$pagination){?>
                        <li class="page-item">
                          ...
                          <form method="post" action="<?php echo base_url(); ?>File_controller/pti_english">
                            <input type="hidden" name="page_no" value="<?php echo $i; ?>">
                            <button class="page-link <?php print ($i==$page_number) ? "active" : ""; ?>" name="pti_eng_page" type="submit">
                    ...
                    <?php }
                     ...
                     <li class="page-item">
                        ...
                        <form method="post" action="<?php echo base_url(); ?>File_controller/pti_english">
                          ...
                          <button class="page-link" name="pti_eng_page" type="submit">
