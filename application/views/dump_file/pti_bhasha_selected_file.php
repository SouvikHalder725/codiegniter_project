            ...
            <div class="col-12 col-lg-12">
              ...
              <div class="card card-table">
                <div class="card-header col-md-12 d-flex">
                   <div class="title col-md-8">Pti Bhasha Selected File</div>
                   ...
                   <div class="tools dropdown col-md-2 d-flex">
                    ...
                    <div class="dropdown col-md-3 mx-2 ">
                     ...
                     <div class="btn btn-secondary col-md-3 mx-2"><i class="fa fa-download"></i></div>
                      <a href="<?php echo base_url(); ?>welcome/pti_bhasha_selected_file" class="btn btn-info col-md-3 mx-2"> <i class="fa-solid fa-rotate"></i></a>
                ...
                <div class="card-body table-responsive">
                  ...
                  <?php foreach ($array as $value) { 
                         ...
                         if($length>3){ ?>
                      <tr>
                        <!-- <td align="center"><input type="checkbox" name="checked_input_value[]" id="checked_input_value" class="checkbox" value=""/></td>         -->
                        ...
                        <td class="actions"><a class="btn btn-success" href="<?php echo base_url('welcome/pti_bhasha_file/'.$value['scan_result'].''); ?>">Enter</a></td>
                      </tr>
