                   ...
                   <div class="tools dropdown col-md-8 d-flex">
                    <form class="col-md-10">
                      <div class="col-md-10 d-flex">
                        <input type="text" name="" id="search_news_subject" placeholder="Search News" class="form-control mx-1 col-md-10">
                        <button type="submit" name="" id="search_news_button" value="search" class="btn btn-secondary mx-1 col-md-2"><i class="fa fa-search mx-1"></i></button>
