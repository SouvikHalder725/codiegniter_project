                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <img src="<?php echo base_url(); ?>document_uploads/<?php echo $value->date; ?>/PTI_Photos/<?php echo $value->file_name; ?>" width="80" height="80" alt="Pti Photo">
                        ...
                        <td>
                           <?php  
                                    ...
                                    <div id="pick_form">
                                      <form method="post" action="<?php echo base_url(); ?>Archivepick_controller/archive_pick_pti_photos_story">
