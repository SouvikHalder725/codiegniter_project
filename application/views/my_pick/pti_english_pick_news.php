            ...
            <div class="col-12 col-lg-12">
              ...
              <div class="card card-table">
                <div class="card-header col-md-12 d-flex">
                   ...
                   <div class="title col-md-9">PTI ENGLISH</div>
                  ...
                  <table class="table table-striped table-hover text-left">
                    ...
                    <tbody>
                      ...
                      foreach ($file_name as $value) {
                         $list=scandir('document_uploads/picked/'.$value->date.'/PTI_ENG');
                            ...
                            foreach ($list as $new_value) { 
                              ...
                              if($length>5){
                              $file_list=scandir('document_uploads/picked/'.$value->date.'/PTI_ENG/'.$new_value.'/');
                      ...
                      ?>
                                            ...
                                            <tr>
                                                ...
                                                <div class="d-flex mx-2 text-center"> 
                                                    ...
                                                    <a class="btn btn-success mx-2" href="#" type="button" data-bs-toggle="modal" data-bs-target="#realise_story_modal_<?php echo $value->id; ?>"><i class="fa fa-hand-pointer"></i></a>
                                                     ...
                                                     <!-- <a  onclick="withJquery(<?php echo $value->id; ?>);" class="btn btn-primary"><i class="fa fa-copy"></i></a> -->
                                                      <a href="#"  onclick="pti_eng_translate('<?php echo $value->id; ?>');" id="pti_translate" type="button" data-bs-toggle="modal" data-bs-target="#hindi_tittle_modal_<?php echo $value->id; ?>" class="btn btn-primary mx-2"><i class="fa fa-language"></i></a>  
                                                  ...
                                                  <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                      <div class="row col-md-12 mx-3 my-3 text-left">
                                                         ...
                                                         <hr>
                                                        <textarea style="font-size:20px;" class="form-control" id="pti_eng_hindi_text_<?php echo $value->id; ?>" cols="20" rows="15"><?php  echo $value->text; ?></textarea>
                                                      </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                              ...
                                              <!--  modal -->
                                               ...
                                               <script type="text/javascript">
                                                      ...
                                                      function hindi_copy(id) {
                                                        let copyText = document.querySelector("#pti_eng_hindi_text_"+id+"");
                                                        copyText.select();
                                                        document.execCommand("copy");
                                                      } 
                                              ...
                                              <div class="modal fade" id="realise_story_modal_<?php echo $value->id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-xl">
                                                  <div class="modal-content">
                                                     <form method="post" action="<?php echo base_url(); ?>Mywork_controller/pti_english_realise_report">
                                                    <div class="modal-header">
