                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <img src="<?php echo base_url(); ?>document_uploads/<?php echo $value->date; ?>/UNI_Photos/<?php echo $value->file_name; ?>" width="80" height="80" alt="Uni Photo">
                                      ...
                                      <div class="modal-content" style="width:100%;">
                                        ...
                                        <div class="modal-body">
                                          <div class="row col-md-12 mx-3 my-3 text-left">
                                            ...
                                            <img width="" height="" src="<?php echo base_url(); ?>document_uploads/UNI_Photos/<?php echo $value->date; ?>/<?php echo $value->file_name; ?>">
