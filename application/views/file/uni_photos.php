            ...
            <div class="col-12 col-lg-12">
              <div class="card card-table">
                <div class="card-header col-md-12 d-flex">
                    ...
                    <div class="title col-md-4">UNI PHOTOS</div>
                     
                  <div class="tools dropdown col-md-8 d-flex">
                    <form class="col-md-10" action="<?php echo base_url(); ?>Search_controller/uni_photos_search" method="post">
                      ...
                      <a href="<?php echo base_url(); ?>File_controller/uni_photos" class="btn btn-info col-md-1 mx-1"> <i class="fa-solid fa-rotate"></i></a>
                ...
                <div class="card-body table-responsive">
                    ...
                    <tbody>
                      ...
                      foreach ($file_name as $value) {
                          ...
                          // $info = exif_read_data("C:\Wire_Agency\UNI_Photos/".$value."",0,true);                                                
                            $size = getimagesize("document_uploads/".$value->date."/UNI_Photos/".$value->file_name."", $info);
                            ...
                            if(is_array($info)) 
                            {
                              if(isset($info['APP13'])){
                                  ...
                                  $data_title_saved=$this-> db ->update('uni_photos');                                                             
                               }
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <img id="news_img" src="<?php echo base_url(); ?>document_uploads/<?php echo $date; ?>/UNI_Photos/<?php echo $value->file_name; ?>" width="80" height="80" alt="Uni Photo">
                        ...
                        <td>
                           ...
                           <?php  
                                    ...
                                    $list=scandir('document_uploads/picked/'.$date.'/UNI_Photos');
                                        ...
                                        foreach ($list as $new_value) { 
                                          ...
                                          if($length>5){
                                          $file_list=scandir('document_uploads/picked/'.$date.'/UNI_Photos/'.$new_value.'/');
                                    ...
                                    <div id="pick_form">
                                      <form method="post" action="<?php echo base_url(); ?>File_controller/pic_uni_photos">
                        ...
                        <td>
                            <div class="d-flex mx-2 text-center"> 
                                 ...
                                 <?php 
                                    ...
                                    $data_res= $this-> db ->get('uni_photos_pick_realise');
                                      ...
                                      <div class="modal-content" style="width:100%;">
                                        ...
                                        <div class="modal-body">
                                          <div class="row col-md-12 mx-3 my-3 text-left">
                                            ...
                                            <img width="" height="" src="<?php echo base_url(); ?>document_uploads/picked/<?php echo $date; ?>/UNI_Photos/<?php echo $value->file_name; ?>">
                 ...
                 <div class="col-md-12 my-1">
                  ...
                  <nav aria-label="Page navigation example text-center my-3">
                    <ul class="pagination">
                      <li class="page-item">
                        <a class="page-link" href="<?php echo base_url(); ?>File_controller/uni_photos" aria-label="Previous">
                    ...
                    if($i>0 && $i<=$pagination){?>
                        <li class="page-item">
                          ...
                          <form method="post" action="<?php echo base_url(); ?>File_controller/uni_photos">
                            <input type="hidden" name="page_no" value="<?php echo $i; ?>">
                            <button class="page-link <?php print ($i==$page_number) ? "active" : ""; ?>" name="uni_photo_page" type="submit">
                    ...
                    <?php }
                       ...
                       <li class="page-item">
                          ...
                          <form method="post" action="<?php echo base_url(); ?>File_controller/uni_photos">
                            ...
                            <button class="page-link" name="uni_photo_page" type="submit">
