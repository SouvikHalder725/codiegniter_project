            ...
            <div class="col-12 col-lg-12">
              ...
              <div class="card card-table">
                <div class="card-header col-md-12 d-flex">
                   ...
                   <div class="title col-md-9">UNI VARTA</div>
                  ...
                  <table class="table table-striped table-hover text-left">
                    ...
                    <tbody>
                      ...
                      foreach ($file_name as $value) {
                         $list=scandir('document_uploads/picked/'.$value->date.'/UNI_Varta');
                            ...
                            foreach ($list as $new_value) { 
                              ...
                              if($length>5){
                              $file_list=scandir('document_uploads/picked/'.$value->date.'/UNI_Varta/'.$new_value.'/');
                      ...
                      ?>
                                            ...
                                            <tr>
                                                  ...
                                                  <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                       <button onclick="uni_varta_copy(<?php echo $value->id; ?>);" type="button" class="btn btn-primary"><i class="fa fa-copy mx-1"></i>Copy</button>
                                                    </div>
                                                  </div>
                                                </div>
                                              </div>
                                              ...
                                              <div class="modal fade" id="realise_story_modal_<?php echo $value->id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-xl">
                                                  <div class="modal-content">
                                                     <form method="post" action="<?php echo base_url(); ?>Mywork_controller/uni_varta_realise_report">
                                                    <div class="modal-header">
