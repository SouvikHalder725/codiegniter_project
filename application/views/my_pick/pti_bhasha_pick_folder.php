                  ...
                  <table class="table table-striped table-hover text-left">
                    ...
                    <tbody>
                      ...
                      foreach ($list as $value) { 
                        $length=strlen($value);
                        $list2=scandir('document_uploads/picked/'.$date.'/PTI_BHASHA/'.$value.'');
                         ...
                         if($length>5){
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url('Mywork_controller/pti_bhasha_pick_news/'.$value.''); ?>"><h3><i class="fa fa-folder"></i> <?php echo $value; ?></h3></a>
                            </td>
                            <td>
