            ...
            <div class="col-12 col-lg-12">
              <div class="card card-table">
                <div class="card-header col-md-12 d-flex">
                 ...
                 <div class="title col-md-8">Pti English Selected File</div>
                 <div class="tools dropdown col-md-2 d-flex">
                   ...
                   <!--  <div class="btn btn-success col-md-3 mx-2"><a  href="#"><i class="fa fa-check text-light"></i></a></div> -->
                    <a href="<?php echo base_url(); ?>welcome/pti_english_selected_file" class="btn btn-warning col-md-3 mx-2"><i class="fa fa-file"></i></a>
                    ...
                    <div class="dropdown col-md-3 mx-2 ">
                     ...
                     <a href="<?php echo base_url(); ?>welcome/pti_english_selected_file" class="btn btn-info col-md-3 mx-2"><i class="fa-solid fa-rotate"></i></a>

                     <a href="<?php echo base_url(); ?>welcome/pti_english" class="btn btn-warning col-md-3 mx-2"><i class="fa fa-close"></i></a>
                  </div>
                    ...
                    <tbody>
                      ...
                      <tr>
                         <td class="user-avatar d-flex">
                          <div>
                               <img src="<?php echo base_url(); ?>asset/img/english_file_icon.webp" width="100" height="100" alt="Avatar">
                              </div>
                              <div>
                        ...
                        <td class="actions"><a class="btn btn-success" href="<?php echo base_url('welcome/pti_english_file/'.$value['scan_result'].''); ?>">Enter</a></td>
                      </tr>
