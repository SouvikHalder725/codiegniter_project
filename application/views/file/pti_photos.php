                ...
                <div class="card-body table-responsive">
                 ...
                 <div class="col-md-12 my-1">
                  ...
                  <nav aria-label="Page navigation example text-center my-3">
                    <ul class="pagination">
                      <li class="page-item">
                        <a class="page-link" href="<?php echo base_url(); ?>File_controller/pti_photos" aria-label="Previous">
                    ...
                    if($i>0 && $i<=$pagination){?>
                        ...
                        <li class="page-item">
                          ...
                          <form method="post" action="<?php echo base_url(); ?>File_controller/pti_photos">
                            <input type="hidden" name="page_no" value="<?php echo $i; ?>">
                            <button class="page-link <?php print ($i==$page_number) ? "active" : ""; ?>" name="pti_photo_page" type="submit">
                    ...
                    <?php }
                      ...
                      <li class="page-item">
                          ...
                          <form method="post" action="<?php echo base_url(); ?>File_controller/pti_photos">
                            ...
                            <button class="page-link" name="pti_photo_page" type="submit">
