                    ...
                    <tbody>
                      ...
                      foreach ($file_name as $value) {
                          ...
                          $list=scandir('document_uploads/picked/'.$value->date.'/LOCAL_PHOTOS');
                              ...
                              foreach ($list as $new_value) { 
                                ...
                                if($length>5){
                                $file_list=scandir('document_uploads/picked/'.$value->date.'/LOCAL_PHOTOS/'.$new_value.'/');
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <img id="copyimg_<?php echo $value->id; ?>" src="<?php echo base_url(); ?>document_uploads/<?php echo $value->date; ?>/LOCAL_PHOTOS/<?php echo $value->file_name; ?>" width="80" height="80" alt="Uni Photo">
                        ...
                        <td>
                            <div class="d-flex mx-2 text-center">                                                                                    
                                <a class="btn btn-light mx-2" href="#" type="button" data-bs-toggle="modal" data-bs-target="#view_uni_photo_story_modal_<?php echo $value->id; ?>">
                                  <i class="fa fa-eye"></i>
                                </a>          
                                ...
                                <a href="<?php echo base_url('welcome/local_photo_download/'.$value->date.'/'.$value->file_name.''); ?>" class="btn btn-secondary mx-1" >
                                  <i class="fa fa-download"></i>
                                </a>
                                <a  id="copy" onclick="withJquery('<?php echo $value->id; ?>');" class="btn btn-primary">
                                  <i class="fa fa-copy"></i>
                                </a>
                                <a href="#"  onclick="local_photo_translate('<?php echo $value->id; ?>');" id="pti_translate" type="button" data-bs-toggle="modal" data-bs-target="#hindi_tittle_modal_<?php echo $value->id; ?>" class="btn btn-primary mx-2"><i class="fa fa-language"></i></a>                                             
                              </div>
                                      ...
                                      <div class="modal-content" style="width:100%;">
                                        ...
                                        <div class="modal-body">
                                          <div class="row col-md-12 mx-3 my-3 text-left">
                                            ...
                                            <img width="400" height="400" src="<?php echo base_url(); ?>document_uploads/<?php echo $value->date; ?>/LOCAL_PHOTOS/<?php echo $value->file_name; ?>">
                                      ...
                                      <div class="modal-content" style="width:100%;">
                                        ...
                                        <div class="modal-body">
                                          <div class="row col-md-12 mx-3 my-1 text-left">
                                            ...
                                            <img width="400" height="400" id="copyimg_two" src="<?php echo base_url(); ?>document_uploads/<?php echo $value->date; ?>/LOCAL_PHOTOS/<?php echo $value->file_name; ?>">
                                              ...
                                              <div class="modal fade" id="realise_story_modal_<?php echo $value->id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-xl">
                                                  <div class="modal-content">
                                                     <form method="post" action="<?php echo base_url(); ?>Local_controller/local_photos_realise_report">
                                                    <div class="modal-header">
