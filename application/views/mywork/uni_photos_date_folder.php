            ...
            <div class="col-12 col-lg-12">
              ...
              <div class="card card-table">
                <div class="card-header col-md-12 d-flex">
                   ...
                   <div class="title col-md-8">UNI PHOTOS</div>
                ...
                <div class="card-body table-responsive">
                  ...
                  <table class="table table-striped table-hover text-left">
                    ...
                    <tbody>
                      ...
                      $list=scandir('document_uploads/UNI_Photos');
                        ...
                        $length=strlen($value);
                         ...
                         if($length>5 && $value!="picked"){
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url('Mywork_controller/uni_photos_news_date_folder/'.$value.''); ?>"><h3><i class="fa fa-folder"></i> <?php echo $value; ?></h3></a>
                            </td>
                            <td>
                              <!-- <a class="btn btn-primary" href="#"><i class="fa fa-edit"></i></a>
                              <a class="btn btn-info" href="#"><i class="fa fa-file"></i></a> -->
                               <a class="btn btn-danger" href="#" onclick="confirm_del_uni_photos()"><i class="fa fa-trash"></i></a>
                                  <input type="hidden" name="value" id="confirm_del_uni_photos" value="<?php echo $value; ?>">
