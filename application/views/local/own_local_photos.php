            ...
            <div class="col-12 col-lg-12">
              <div class="card card-table">
                <div class="card-header col-md-12 d-flex">
                    ...
                    <div class="title col-md-4">LOCAL PHOTOS</div>
                    


                    <div class="tools dropdown col-md-8 d-flex">
                      <form class="col-md-8" action="<?php echo base_url(); ?>Search_controller/local_photos_search" method="post">
                     ...
                     <a class="btn btn-primary mx-2 text-center col-md-2" href="<?php echo base_url(); ?>Local_controller/local_photos_form"><i class="fa fa-plus mx-1"></i><b>Upload Photos</b></a>
                    
                     <a href="<?php echo base_url(); ?>Local_controller/own_local_photos" class="btn btn-info mx-1 col-md-1"> <i class="fa-solid fa-rotate mx-1"></i><b></b></a>

                     <a href="<?php echo base_url(); ?>welcome/dashboard" class="btn btn-secondary mx-1 col-md-1"><i class="fa fa-arrow-left mx-1"></i><b></b></a>
                    </div>
                ...
                <div class="card-body table-responsive">
                      ...
                      foreach ($file_name as $value) {
                       ...
                       // this is for getting image information hide inside the image coming from pti or uni   
                        ...
                        // $info = exif_read_data("C:\Wire_Agency\UNI_Photos/".$value."",0,true);                                                
                          ...
                          if(is_array($info)) 
                          {
                            if(isset($info['APP13'])){
                              ...
                              $data_title_saved=$this-> db ->update('local_photos');
                        ...
                        <td>
                          ...
                          <img id="news_img"  src="<?php echo base_url(); ?>document_uploads/<?php echo $date; ?>/LOCAL_PHOTOS/<?php echo $value->file_name; ?>" width="80" height="80" alt="Pti Photo">
                        ...
                        <td>
                           <?php  
                                  ...
                                  $list=scandir('document_uploads/picked/'.$date.'/LOCAL_PHOTOS');
                                      ...
                                      foreach ($list as $new_value) { 
                                        ...
                                        if($length>5){
                                        $file_list=scandir('document_uploads/picked/'.$date.'/LOCAL_PHOTOS/'.$new_value.'/');
                                    ...
                                    <div id="pick_form">
                                      <form method="post" action="<?php echo base_url(); ?>Local_controller/pick_local_photos">
                        ...
                        <td>
                          <div class="d-flex mx-2 text-center"> 
                               ...
                               <?php 
                                  ...
                                  $data_res= $this-> db ->get('local_photos_pick_realise');
                                      ...
                                      <div class="modal-content" style="width:100%;">
                                        ...
                                        <div class="modal-body">
                                          <div class="row col-md-12 mx-3 my-3 text-left">
                                            ...
                                            <img width="" height="" src="<?php echo base_url(); ?>document_uploads/picked/<?php echo $date; ?>/LOCAL_PHOTOS/<?php echo $value->file_name; ?>">
                 ...
                 <div class="col-md-12 my-1">
                  ...
                  <nav aria-label="Page navigation example text-center my-3">
                    <ul class="pagination">
                      <li class="page-item">
                        <a class="page-link" href="<?php echo base_url(); ?>Local_controller/own_local_photos" aria-label="Previous">
                          <h6><b><span aria-hidden="true">&laquo;</span></b></h6>
                        </a>
                      </li>
                    ...
                    if($i>0 && $i<=$pagination){?>
                        ...
                        <li class="page-item">
                          ...
                          <form method="post" action="<?php echo base_url(); ?>Local_controller/own_local_photos">
                            <input type="hidden" name="page_no" value="<?php echo $i; ?>">
                            <button class="page-link <?php print ($i==$page_number) ? "active" : ""; ?>" name="photo_page" type="submit">
                              <h6><b><?php echo $i; ?></b></h6>
                            </button>
                    ...
                    <?php }
                      ...
                      <li class="page-item">
                          ...
                          <form method="post" action="<?php echo base_url(); ?>Local_controller/own_local_photos">
                            <input type="hidden" name="page_no" value="<?php echo $pagination; ?>">
                            <button class="page-link" name="photo_page" type="submit">
                              <h6><b><span aria-hidden="true">&raquo;</span></b></h6>
                            </button>
