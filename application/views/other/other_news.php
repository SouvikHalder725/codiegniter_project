              ...
              <div class="card card-table">
                <div class="card-header col-md-12 d-flex">
                   ...
                   <div class="tools dropdown col-md-8 d-flex">
                    ...
                    <form class="col-md-10" action="<?php echo base_url(); ?>Search_controller/other_news_search" method="post">
                     ...
                     <a href="<?php echo base_url(); ?>Bengali_controller/other_news" class="btn btn-info col-md-1 mx-2"> <i class="fa-solid fa-rotate"></i></a>

                     <a href="<?php echo base_url(); ?>welcome/dashboard" class="btn btn-warning col-md-1 mx-2"><i class="fa fa-close"></i></a>
                  </div>
               ...
               <div class="col-md-12 my-1">
                ...
                <nav aria-label="Page navigation example text-center my-3">
                  <ul class="pagination">
                    <li class="page-item">
                      <a class="page-link" href="<?php echo base_url(); ?>Bengali_controller/other_news" aria-label="Previous">
                  ...
                  <?php for ($i=$page_number-2; $i <=$page_number+2 ; $i++) { 
                    if($i>0 && $i<=$pagination){?>
                      ...
                      <li class="page-item">
                        ...
                        <form method="post" action="<?php echo base_url(); ?>Bengali_controller/other_news">
                          <input type="hidden" name="page_no" value="<?php echo $i; ?>">
                          <button class="page-link <?php print ($i==$page_number) ? "active" : ""; ?>" name="pti_bengali_page" type="submit">
                  ...
                  <?php }
                     ...
                     <li class="page-item">
                        ...
                        <form method="post" action="<?php echo base_url(); ?>Bengali_controller/other_news">
                          ...
                          <button class="page-link" name="pti_bengali_page" type="submit">
