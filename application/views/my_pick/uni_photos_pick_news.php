            ...
            <div class="col-12 col-lg-12">
              <div class="card card-table">
                <div class="card-header col-md-12 d-flex">
                    ...
                    <div class="title col-md-9">UNI PHOTOS</div>
                  ...
                  <table class="table table-striped table-hover">
                    ...
                    <tbody>
                      ...
                      foreach ($file_name as $value) {
                          ...
                          $list=scandir('document_uploads/picked/'.$value->date.'/UNI_Photos');
                              ...
                              foreach ($list as $new_value) { 
                                ...
                                if($length>5){
                                $file_list=scandir('document_uploads/picked/'.$value->date.'/UNI_Photos/'.$new_value.'/');
                      ...
                      <tr>
                        ...
                        <div class="text-left" style="font-size: 20px;font-weight:bold;"><?php echo $value->file_name; ?></div>
                          ...
                          <img id="copyimg_<?php echo $value->id; ?>" src="<?php echo base_url(); ?>document_uploads/<?php echo $value->date; ?>/UNI_Photos/<?php echo $value->file_name; ?>" width="80" height="80" alt="Uni Photo">
                        ...
                        <td>
                            <div class="d-flex mx-2 text-center"> 
                                  ...
                                  <a class="btn btn-light mx-2" href="#" type="button" data-bs-toggle="modal" data-bs-target="#view_uni_photo_story_modal_<?php echo $value->id; ?>"><i class="fa fa-eye"></i></a>          
                                  <!--  <span class="btn btn-light mx-2"><i class="fa-sharp fa fa-eye-slash"></i></span>  -->
                                  <a class="btn btn-success mx-2" href="#" type="button" data-bs-toggle="modal" data-bs-target="#realise_story_modal_<?php echo $value->id; ?>"><i class="fa fa-hand-pointer"></i></a>
                                   <a href="<?php echo base_url('welcome/uni_download/'.$value->date.'/'.$value->file_name.''); ?>" class="btn btn-secondary mx-1" ><i class="fa fa-download"></i></a>
                                    <a  id="copy" onclick="withJquery('<?php echo $value->id; ?>');" class="btn btn-primary"><i class="fa fa-copy"></i></a>
                                      ...
                                      <div class="modal-content" style="width:100%;">
                                        ...
                                        <div class="modal-body">
                                          <div class="row col-md-12 mx-3 my-3 text-left">
                                            ...
                                            <img width="" height="" src="<?php echo base_url(); ?>document_uploads/<?php echo $value->date; ?>/UNI_Photos/<?php echo $value->file_name; ?>">
                                      ...
                                      <div class="modal-content" style="width:100%;">
                                        ...
                                        <div class="modal-body">
                                          <div class="row col-md-12 mx-3 my-1 text-left">
                                           ...
                                           <img width="350" height="350" src="<?php echo base_url(); ?>document_uploads/<?php echo $value->date; ?>/UNI_Photos/<?php echo $value->file_name; ?>">
                                              ...
                                              <div class="modal fade" id="realise_story_modal_<?php echo $value->id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-xl">
                                                  <div class="modal-content">
                                                     <form method="post" action="<?php echo base_url(); ?>Mywork_controller/uni_photos_realise_report">
                                                    <div class="modal-header">
