            ...
            <div class="col-12 col-lg-12">
              <div class="card card-table">
                <div class="card-header col-md-12 d-flex">
                    ...
                    <div class="title col-md-9">OTHER PHOTOS</div>
                  ...
                  <table class="table table-striped table-hover">
                    ...
                    <tbody>
                      ...
                      foreach ($file_name as $value) {
                          $list=scandir('document_uploads/picked/'.$value->date.'/OTHER_PHOTOS');
                            ...
                            foreach ($list as $new_value) { 
                              ...
                              if($length>5){
                              $file_list=scandir('document_uploads/picked/'.$value->date.'/OTHER_PHOTOS/'.$new_value.'/');
                      ...
                      <tr>
                        ...
                        <td>
                         ...
                         <div class="text-left" style="font-size: 14px;font-weight:bold;" style=""><?php echo $value->file_creation_date_time; ?></div>
                          <img id="copyimg_<?php echo $value->id; ?>"  src="<?php echo base_url(); ?>document_uploads/<?php echo $value->date; ?>/OTHER_PHOTOS/<?php echo $value->file_name; ?>" width="80" height="80" alt="Pti Photo">
                         <!--  -->
                        </td> 
                        <td width="40%">
                          <div class="px-2">
                                      ...
                                      <div class="modal-content" style="width:100%;">
                                        ...
                                        <div class="modal-body">
                                          <div class="row col-md-12 mx-3 my-3 text-left">
                                            ...
                                            <img width="400" height="400" id="copyimg_two" src="<?php echo base_url(); ?>document_uploads/<?php echo $value->date; ?>/OTHER_PHOTOS/<?php echo $value->file_name; ?>">
                                      ...
                                      <div class="modal-content" style="width:100%;">
                                        ...
                                        <div class="modal-body">
                                          <div class="row col-md-12 mx-3 my-1 text-left">
                                            ...
                                            <img width="350" height="350" id="copyimg_two" src="<?php echo base_url(); ?>document_uploads/<?php echo $value->date; ?>/OTHER_PHOTOS/<?php echo $value->file_name; ?>">
