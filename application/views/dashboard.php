            ...
            <div class="col-12 col-lg-12">
              ...
              <div class="card card-table">
                <div class="card-header col-md-12 d-flex">
                   ...
                   <div class="title col-md-8">TODAYS ALL NEWS FOLDER</div>
                      ...
                      foreach ($list as $value) { 
                        $length=strlen($value);
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url('Mywork_controller/'.$value.'_dashboard_news/'.$tw.''); ?>"><h3><i class="fa fa-folder"></i> <?php echo $value; ?></h3></a>
                            </td>
                            <td>
                              <!-- <a class="btn btn-primary" href="#"><i class="fa fa-edit"></i></a> -->
                              <a class="btn btn-info" href="<?php echo base_url('Mywork_controller/'.$value.'_dashboard_news/'.$tw.''); ?>"><i class="fa fa-file"></i></a>
