...
if($length>3){ 
  // $info = exif_read_data("C:\Wire_Agency\UNI_Photos/".$value."",0,true);                                                
    $size = getimagesize("C:\Wire_Agency\UNI_Photos/".$file_name."", $info);
...
<div class="row my-4">
    ...
    <div class="col-12 col-lg-12">
        <form method="post" action="<?php echo base_url(); ?>welcome/pic_uni_photos">
        <div class="card card-table">
            <div class="card-header col-md-12 d-flex">
                <div class="title col-md-9"><b><?php echo $file_name; ?></b></div>
                ...
                <div class="tools dropdown col-md-2 d-flex">
                         ...
                         <a href="<?php echo base_url(); ?>welcome/uni_photos_file/<?php echo $file_name; ?>" class="btn btn-info col-md-3 mx-2"> <i class="fa-solid fa-rotate"></i></a>
