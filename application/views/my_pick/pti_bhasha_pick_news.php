            ...
            <div class="col-12 col-lg-12">
              ...
              <div class="card card-table">
                <div class="card-header col-md-12 d-flex">
                   ...
                   <div class="title col-md-9">PTI BHASHA</div>
                ...
                <div class="card-body table-responsive">
                  ...
                  <table class="table table-striped table-hover text-left">
                    ...
                    <tbody>
                      ...
                      $list=scandir('document_uploads/picked/'.$value->date.'/PTI_BHASHA');
                          ...
                          foreach ($list as $new_value) { 
                           $length=strlen($new_value);
                              ...
                              if($length>5){
                               ...
                               $file_list=scandir('document_uploads/picked/'.$value->date.'/PTI_BHASHA/'.$new_value.'/');
                                              ...
                                              <td>
                                                ...
                                                <div class="d-flex mx-2 text-center"> 
                                                    ...
                                                    <!-- copy text with javascript -->
                                                      ...
                                                      <!-- <a href="#" class="btn btn-primary mx-2"><i class="fa fa-edit mx-1"></i></a> -->
